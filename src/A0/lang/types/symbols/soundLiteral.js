...
export class SoundSymbol extends Symbol {
   ...
   */
  constructor({keyword, queryParams, block, index, audioContext, theme, updates}) {
    super({
    ...
    theme.subscribe(t => {
      this.statusClasses = {
        [SoundStatusType.Searching]:   t.classes.lang[SoundStatusType.Searching],
        [SoundStatusType.Downloading]: t.classes.lang[SoundStatusType.Downloading],
        [SoundStatusType.Available]:   t.classes.lang[SoundStatusType.Available],
        [SoundStatusType.Unavailable]: t.classes.lang[SoundStatusType.Unavailable],
      }
    })
  ...
  async download(queryResult) {
    ...
    this.buffer = await this.audioContext.decodeAudioData(buffer.slice(0), () => {})
