...
export class SymbolTable {
   ...
   */
  constructor({audioContext, theme}) {
    // registry of all known symbols
    this.registry = {
      refs:      {},                        // Map<BlockKey, Array<SymbolId> > references to symbols by block
      sounds:    BuiltinSymbols.sounds,     // Map<SymbolId, Symbol>
      variables: BuiltinSymbols.variables,  // Map<SymbolId, Symbol>
      functions: BuiltinSymbols.functions,  // Map<SymbolId, Symbol>
      _query:    BuiltinSymbols.query,      // internal query function for sound queries
    }
